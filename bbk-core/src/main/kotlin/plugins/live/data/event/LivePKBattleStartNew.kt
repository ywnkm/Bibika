...
@Serializable
public data class LivePKBattleStartNew(
    override val cmd: String = "PK_BATTLE_START_NEW",
    val data: Data,
    val pk_id: Long,
    val pk_status: Int,
    val roomid: String,
    ...
    public companion object : LiveEvent.CMDEvent.CMDEventHelper<LivePKBattleStartNew> {
        override val cmd: String = "PK_BATTLE_START_NEW"
        override val kClass: KClass<LivePKBattleStartNew> = LivePKBattleStartNew::class
    }
}
